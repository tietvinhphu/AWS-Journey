...
<!-- TABLE_START -->
| <div align="center">Bài Lab (Lab)</div> | <div align="center">Chủ đề (Topics)</div> | <div align="center">Trạng thái (Status)</div> | <div align="center">Tài liệu (Resources)</div> |
| :---: | :--- | :---: | :---: |
...
| **[4. AWS Identity and Access Management (IAM) Access Control](./The%20First%20Cloud%20Journey/4.%20AWS%20Identity%20and%20Access%20Management%20%28IAM%29%20Access%20Control)** | <ul><li>Thiết lập môi trường IAM chuẩn, <strong>không dùng Root User</strong> cho công việc hàng ngày</li><li>Hiểu và thực hành kỹ thuật <strong>Switch Role</strong> để bảo mật tối đa</li><li>Nắm vững nguyên tắc <strong>Least Privilege</strong> (Đặc quyền tối thiểu)</li></ul> | ![Done](https://img.shields.io/badge/Status-Completed-success?style=flat-square) | [![Youtube](https://img.shields.io/badge/View-Video-red?style=flat-square&logo=youtube)](https://youtu.be/qqbcZQfB0bE?si=7g7eWHXaF5k3bxLm) |
<!-- TABLE_END -->
